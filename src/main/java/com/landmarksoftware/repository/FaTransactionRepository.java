...
import com.landmarksoftware.model.FaTransactionRow;
...
public class FaTransactionRepository {
    ...
    public List<FaTransactionRow> findDepnTransactions(
        ...
        return jdbc.query(FaSql.FIND_DEPN_TRX_FOR_ASSET, new TrxRowMapper(),
    ...
    public List<FaTransactionRow> findRevalTransactionsAfter(
        ...
        return jdbc.query(FaSql.FIND_REVAL_TRX_AFTER_DATE, new TrxRowMapper(),
                companyNo, assetNo,
    ...
    public List<FaTransactionRow> findAcquisitions(int companyNo, String assetNo) {
        return jdbc.query(
            FaSql.FIND_ACQUISITIONS_FOR_ASSET, new TrxRowMapper(), companyNo, assetNo);
    }
