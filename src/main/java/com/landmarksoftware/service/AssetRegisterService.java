...
public class AssetRegisterService {
    ...
    public String validateLocn(int companyNo, String locCode) {
        ...
        Integer count = jdbc.queryForObject(
            FaSql.COUNT_LOCATION_BY_PK, Integer.class, companyNo, locCode);
    ...
    public String validateGroup(int companyNo, String grpCode) {
        ...
        Integer count = jdbc.queryForObject(
            FaSql.COUNT_GROUP_BY_PK, Integer.class, companyNo, grpCode);
    ...
    public String validateSubGroup(int companyNo, String subGrp) {
        ...
        Integer count = jdbc.queryForObject(
            FaSql.COUNT_SUBGROUP_BY_PK, Integer.class, companyNo, subGrp);
    ...
    public String validateDept(int companyNo, String deptCode) {
        ...
        Integer count = jdbc.queryForObject(
            FaSql.COUNT_DEPARTMENT_BY_PK, Integer.class, companyNo, deptCode);
    ...
    public String lookupLocnDesc(int companyNo, String locCode) {
        ...
        try {
            return jdbc.queryForObject(
                FaSql.FIND_LOCATION_DESC_BY_PK, String.class, companyNo, locCode);
    ...
    public String lookupGroupDesc(int companyNo, String grpCode) {
        ...
        try {
            return jdbc.queryForObject(
                FaSql.FIND_GROUP_DESC_BY_PK, String.class, companyNo, grpCode);
        } catch (Exception e) { return "* NOT ON FILE *"; }
    }
    ...
    public String lookupSubGroupDesc(int companyNo, String subGrp) {
        ...
        try {
            return jdbc.queryForObject(
                FaSql.FIND_SUBGROUP_DESC_BY_PK, String.class, companyNo, subGrp);
        } catch (Exception e) { return "* NOT ON FILE *"; }
    }
    ...
    public String lookupDeptDesc(int companyNo, String deptCode) {
        ...
        try {
            return jdbc.queryForObject(
                FaSql.FIND_DEPARTMENT_DESC_BY_PK, String.class, companyNo, deptCode);
        } catch (Exception e) { return "* NOT ON FILE *"; }
    }
    ...
    private List<AssetRegisterRow> loadAssets(int companyNo,
        ...
        StringBuilder sql = new StringBuilder(FaSql.SELECT_ASSET_REGISTER_PREFIX);
    ...
    private AccumDepnResult calcAccumDepn(int companyNo,
        ...
        try {
            List<Map<String, Object>> rows = jdbc.queryForList(
                FaSql.FIND_FATRANS_FOR_ASSET, companyNo, row.getAssetNo());
    ...
    private void applyDepnDetails(int companyNo, AssetRegisterRow row,
        ...
        try {
            Map<String, Object> a = jdbc.queryForMap(
                FaSql.FIND_DEPN_DETAILS_BY_ASSET, companyNo, row.getAssetNo());
