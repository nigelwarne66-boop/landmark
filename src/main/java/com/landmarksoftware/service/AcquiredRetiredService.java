...
public class AcquiredRetiredService {
    ...
    private List<AcquiredRetiredRow> selectAssets(AcquiredRetiredRequest req) {
        StringBuilder sql = new StringBuilder(FaSql.SELECT_ACQUIRED_RETIRED_ASSETS_PREFIX);
    ...
    private void accumPooledTrxs(AcquiredRetiredRequest req, AcquiredRetiredRow r) {
        ...
        StringBuilder accumWhere = new StringBuilder(FaSql.SELECT_FATRANS_POOLED_ACCUM_PREFIX);
        if (req.getStartDate() != null) {
        ...
        StringBuilder printWhere = new StringBuilder(FaSql.SELECT_FATRANS_POOLED_DETAIL_PREFIX);
        if (req.getStartDate() != null) {
