...
public class FaAssetRepository {
    ...
    public List<AssetRow> findByRanges(
        ...
        // TODO: replace schema/column names with your actual migration target names
        String sql = """
            SELECT
        ...
        return jdbc.query(sql, new AssetRowMapper(),
                companyNo,
    ...
    public AssetRow findByAssetNo(int companyNo, String assetNo) {
        String sql = "SELECT * FROM FAASSET WHERE company_no = ? AND asset_no = ?";
        List<AssetRow> rows = jdbc.query(sql, new AssetRowMapper(), companyNo, assetNo);
