...
import com.example.fixedassets.payroll.ui.PayrollMenuController;
...
public class MainMenuController {
    ...
    private HBox buildSidebarLogo() {
        javafx.scene.image.ImageView pin = new javafx.scene.image.ImageView();
        try {
            var s = getClass().getResourceAsStream("/images/landmarklogopin.png");
            if (s != null) pin.setImage(new javafx.scene.image.Image(s));
        } catch (Exception ignored) {}
        pin.setFitHeight(56); pin.setFitWidth(56);
        pin.setPreserveRatio(true); pin.setSmooth(true);
    ...
    private VBox buildPayrollTabContent() {
        ...
        // Setup card
        grid.add(buildModuleCard("Setup & Maintenance",
            "#1A6EF5",
        ...
        // Pay Processing card
        grid.add(buildModuleCard("Pay Processing",
            "#059669",
        ...
        // Reports card
        grid.add(buildModuleCard("Reports & Compliance",
            "#7C3AED",
        ...
        // Year End card
        grid.add(buildModuleCard("Year End",
            "#D97706",
    ...
    private VBox buildModuleCard(String title, String accentColor,
    ...
    private HBox buildPageTitle() {
        ...
        try {
            var stream = getClass().getResourceAsStream("/images/landmarklogopin.png");
            if (stream != null)
                logoImg.setImage(new javafx.scene.image.Image(stream));
        } catch (Exception ignored) {}
