...
import com.example.fixedassets.service.AcquisitionService;
...
public class AcquisitionEntryController {
    ...
    public AcquisitionEntryController(AcquisitionService acqService, AppSession appSession) {
    ...
    private void openEntryDlg(AcqnRow existing, Window owner) {
        ...
        btnTaxCode.setOnAction(e -> new LookupDialog(jdbc, LookupDialog.LookupType.DEPN_CODE, companyNo,
            code -> { fTaxCode.setText(code.trim()); lTaxCDesc.setText(acqService.lookupDesc(companyNo, "FACODDN", "depn_code", code.trim())); }).show(dlg));
        btnBookCode.setOnAction(e -> new LookupDialog(jdbc, LookupDialog.LookupType.DEPN_CODE, companyNo,
    ...
    private void addLookupRow(GridPane g, int row, String label,
        ...
        btn.setOnAction(e -> new LookupDialog(jdbc, type, companyNo, code -> {
    ...
    private HBox lookupRow(TextField fld, LookupDialog.LookupType type, Window owner) {
        Button btn = lookupBtn();
        btn.setOnAction(e -> new LookupDialog(jdbc, type, companyNo,
